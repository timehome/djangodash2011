...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('wall_provider', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='providers', to=orm['auth.User'])),
            ('provider_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('update_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('wall', ['Provider'])

        # Changing field 'Album.url'
        db.alter_column('wall_album', 'url', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))


    def backwards(self, orm):
        
        # Deleting model 'Provider'
        db.delete_table('wall_provider')

        # Changing field 'Album.url'
        db.alter_column('wall_album', 'url', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
