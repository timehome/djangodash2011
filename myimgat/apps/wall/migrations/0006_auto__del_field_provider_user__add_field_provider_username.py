...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('wall_provider', 'user_id')

        # Adding field 'Provider.username'
        db.add_column('wall_provider', 'username', self.gf('django.db.models.fields.CharField')(default='heynemann', max_length=100, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Provider.user'
        raise RuntimeError("Cannot reverse this migration. 'Provider.user' and its values cannot be restored.")

        # Deleting field 'Provider.username'
        db.delete_column('wall_provider', 'username')
