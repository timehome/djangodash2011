...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CroppedPhoto'
        db.create_table('wall_croppedphoto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('original_photo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='crops', to=orm['wall.Photo'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cropped_photos', null=True, to=orm['auth.User'])),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=500, db_index=True)),
        ))
        db.send_create_signal('wall', ['CroppedPhoto'])


    def backwards(self, orm):
        
        # Deleting model 'CroppedPhoto'
        db.delete_table('wall_croppedphoto')
