    ...
    var CropPopin = global.CropPopin = new Class({
        ...
        share: function(e) {
            ...
            this.request.addEvent('success', function(response) {
                ...
                var twitter = '<div class="social-item twitter"><a target="_blank" title="tweet this image" href="http://twitter.com/share?url=' + shareUrl + '&via=myimgat&text=' + self.image.title + '" class="twitter-share-button"><img src="/site_media/static/wall/img/tweetn.png" alt="tweet this image" /></a></div>';
